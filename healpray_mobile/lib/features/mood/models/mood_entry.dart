...
class MoodEntry with _$MoodEntry {
  ...
  factory MoodEntry.fromFirestore(DocumentSnapshot<Map<String, dynamic>> snapshot) {
  ...
  double get moodScore {
    ...
    final intensityMultiplier = intensity.value / 3.0; // Normalize around 3 (moderate)
  ...
  bool get indicatesDistress {
    return moodScore <= 2.0 || 
           emotions.any((e) => e.category == EmotionCategory.anger || 
    ...
    for (final trigger in triggers) {
      switch (trigger.category) {
        ...
        case MoodTriggerCategory.crisisSupport:
          practices.addAll(['Crisis Prayer', 'Comfort Scriptures', 'Community Support']);
          break;
        case MoodTriggerCategory.relationships:
          practices.addAll(['Forgiveness Prayer', 'Relationship Blessing', 'Love Meditation']);
          break;
        default:
          break;
      }
...
class MoodContext with _$MoodContext {
  ...
  factory MoodContext.fromJson(Map<String, Object?> json) => _$MoodContextFromJson(json);
}
